...
class hanoi_graphics(object):
    ...
    def animate_disk_move(self,disk,to_rod,to_z_order):
        self.animate_motion_to_pos(self.disks[disk],(self.disks[disk].pos.x,self.disks[disk].pos.y,self.rod_height + self.disk_thickness))
        self.animate_motion_to_pos(self.disks[disk],(self.rods[to_rod].pos.x,self.rods[to_rod].pos.y,self.rod_height + self.disk_thickness))
        self.animate_motion_to_pos(self.disks[disk],(self.rods[to_rod].pos.x,self.rods[to_rod].pos.y,self.disk_thickness * to_z_order))
